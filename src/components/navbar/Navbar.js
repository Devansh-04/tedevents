    ...
    return (
        ...
        <div className={styles.nav}>
            ...
            <div className={styles.right}>
                ...
                <NavLink to='/Registration' className={styles.lin} style={({isActive})=>showActivePage(isActive,'red')}>THANK YOU</NavLink>
                ...
                shortnav ?
                        <div className={styles.sidehead}>
                            <div className={styles.head}>
                                ...
                                <NavLink to='/Registration' className={styles.lin1} style={({isActive})=>showActivePage(isActive,'red')}>Thank You</NavLink>
